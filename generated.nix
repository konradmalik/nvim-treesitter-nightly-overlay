...
}:
{
  ada = buildGrammar {
    passthru.name = "ada";
    language = "ada";
    version = "0.0.0+rev=dd5fa4cdb3aba91abc687aa68fb1431396fce6a6";
    src = fetchFromGitHub {
      owner = "briot";
      repo = "tree-sitter-ada";
      rev = "dd5fa4cdb3aba91abc687aa68fb1431396fce6a6";
      hash = "sha256-0D9TgpEDos6vlgTjQCJjJQblpPaSgjg7uG7SB371DFM=";
    };
  ...
  angular = buildGrammar {
    ...
    language = "angular";
    version = "0.0.0+rev=38a8014ed5452cd6b7cf1399c00177a1f5374256";
    src = fetchFromGitHub {
      owner = "dlvandenberg";
  ...
  apex = buildGrammar {
    passthru.name = "apex";
    language = "apex";
    version = "0.0.0+rev=da568eee10ce4724a40f368b2b7e795dacb4f1ba";
    src = fetchFromGitHub {
      owner = "aheber";
      repo = "tree-sitter-sfapex";
      rev = "da568eee10ce4724a40f368b2b7e795dacb4f1ba";
      hash = "sha256-lnRmC8eGcoVIFpn9pB2XbvNSiHxR9h9Vup6aJUOevIQ=";
    };
  ...
  arduino = buildGrammar {
    ...
    language = "arduino";
    version = "0.0.0+rev=11dd46c9ae25135c473c0003a133bb06a484af0c";
    src = fetchFromGitHub {
  ...
  asm = buildGrammar {
    passthru.name = "asm";
    language = "asm";
    version = "0.0.0+rev=839741fef4dab5128952334624905c82b40c7133";
    src = fetchFromGitHub {
      owner = "RubixDev";
  ...
  beancount = buildGrammar {
    ...
    language = "beancount";
    version = "0.0.0+rev=c8a9780610dbe8ade4888045b1f2caa7a0a9d8aa";
    src = fetchFromGitHub {
      owner = "polarmutex";
  ...
  blade = buildGrammar {
    passthru.name = "blade";
    language = "blade";
    version = "0.0.0+rev=b5291d1ba207a8ebb8383b2ecb8a8a6535210a50";
    src = fetchFromGitHub {
      owner = "EmranMR";
      repo = "tree-sitter-blade";
      rev = "b5291d1ba207a8ebb8383b2ecb8a8a6535210a50";
      hash = "sha256-rWqMN5UJXs0jiFwP2UuCvmg1EphzQqP8/gHj/kdqYpQ=";
    };
  ...
  bpftrace = buildGrammar {
    ...
    language = "bpftrace";
    version = "0.0.0+rev=8269e497af01ef26edea3283bc21ed71ada61f44";
    src = fetchFromGitHub {
      owner = "sgruszka";
      repo = "tree-sitter-bpftrace";
      rev = "8269e497af01ef26edea3283bc21ed71ada61f44";
      hash = "sha256-ZaRyPsZ1JPmsGahSS2WYbRoiGWSM9psN1O5JrsBgH3U=";
    };
  ...
  brightscript = buildGrammar {
    ...
    version = "0.0.0+rev=0c534d56bb04778d0a3510bed5e720d1fe15cb76";
    src = fetchFromGitHub {
      owner = "ajdelcimmuto";
  ...
  c = buildGrammar {
    passthru.name = "c";
    language = "c";
    version = "0.0.0+rev=b780e47fc780ddc8da13afa35a3f4ed5c157823d";
    src = fetchFromGitHub {
      owner = "tree-sitter";
      repo = "tree-sitter-c";
  ...
  c3 = buildGrammar {
    passthru.name = "c3";
    language = "c3";
    version = "0.0.0+rev=e4d3418873ff9f36c71474b5b08c204289f46fb0";
    src = fetchFromGitHub {
      owner = "c3lang";
      repo = "tree-sitter-c3";
      rev = "e4d3418873ff9f36c71474b5b08c204289f46fb0";
      hash = "sha256-wakeoXv/42fy7F7beYGNvqMANpzpC3jOsv6kK5NY+4Q=";
    };
  ...
  cmake = buildGrammar {
    passthru.name = "cmake";
    language = "cmake";
    version = "0.0.0+rev=58993af75218bc99a1f5a04c832a5937e7c422cb";
    src = fetchFromGitHub {
      owner = "uyha";
      repo = "tree-sitter-cmake";
      rev = "58993af75218bc99a1f5a04c832a5937e7c422cb";
      hash = "sha256-zfdjVYSiLoYH/Xj+kT8CdKNQ7f96UptG7Yy/4IxVkfQ=";
    };
  ...
  comment = buildGrammar {
    ...
    language = "comment";
    version = "0.0.0+rev=66272d2b6c73fb61157541b69dd0a7ce7b42a5ad";
    src = fetchFromGitHub {
      owner = "stsewd";
  ...
  cpp = buildGrammar {
    passthru.name = "cpp";
    language = "cpp";
    version = "0.0.0+rev=c009222808634c1014f82438d4883753516a2c24";
    src = fetchFromGitHub {
      owner = "tree-sitter";
      repo = "tree-sitter-cpp";
      rev = "c009222808634c1014f82438d4883753516a2c24";
      hash = "sha256-SYAs+SgXB+gBpdmyW1r6rZUalZUz45fwE+zbHk1EIFk=";
    };
  ...
  csv = buildGrammar {
    passthru.name = "csv";
    language = "csv";
    version = "0.0.0+rev=f6bf6e35eb0b95fbadea4bb39cb9709507fcb181";
    src = fetchFromGitHub {
      owner = "tree-sitter-grammars";
  ...
  cuda = buildGrammar {
    passthru.name = "cuda";
    language = "cuda";
    version = "0.0.0+rev=d58080a327756e4d1d16ec329ba7cb2048f6c6cd";
    src = fetchFromGitHub {
      owner = "tree-sitter-grammars";
  ...
  cue = buildGrammar {
    passthru.name = "cue";
    language = "cue";
    version = "0.0.0+rev=dd7b90e0770ff18070c515937ba3c3d6d93db00e";
    src = fetchFromGitHub {
      owner = "eonpatapon";
  ...
  d = buildGrammar {
    passthru.name = "d";
    language = "d";
    version = "0.0.0+rev=64f27931b4e6fdd75af1102c79bacbca68a8dacc";
    src = fetchFromGitHub {
      owner = "gdamore";
      repo = "tree-sitter-d";
  ...
  dart = buildGrammar {
    passthru.name = "dart";
    language = "dart";
    version = "0.0.0+rev=be07cf7118d3dba06236a3f19541685a68209934";
    src = fetchFromGitHub {
      owner = "UserNobody14";
  ...
  devicetree = buildGrammar {
    ...
    language = "devicetree";
    version = "0.0.0+rev=e78bf56f206cb47bee28a217423acb651e076848";
    src = fetchFromGitHub {
      owner = "joelspadin";
  ...
  diff = buildGrammar {
    passthru.name = "diff";
    language = "diff";
    version = "0.0.0+rev=ada384ac7bfc1307f32de474620120add29998fb";
    src = fetchFromGitHub {
      owner = "tree-sitter-grammars";
      repo = "tree-sitter-diff";
      rev = "ada384ac7bfc1307f32de474620120add29998fb";
  ...
  djot = buildGrammar {
    passthru.name = "djot";
    language = "djot";
    version = "0.0.0+rev=759a61896ccb2200a4becec4443e768638a21d58";
    src = fetchFromGitHub {
      owner = "treeman";
  ...
  doxygen = buildGrammar {
    ...
    language = "doxygen";
    version = "0.0.0+rev=6069b1815b139080d6c562b5ff9ae2296cbc6602";
    src = fetchFromGitHub {
      owner = "tree-sitter-grammars";
      repo = "tree-sitter-doxygen";
      rev = "6069b1815b139080d6c562b5ff9ae2296cbc6602";
      hash = "sha256-nHxh54k0WXDAWkrRPEXUvf+74a0xQGL3/dYKAIM2N/8=";
    };
  ...
  dtd = buildGrammar {
    passthru.name = "dtd";
    language = "dtd";
    version = "0.0.0+rev=5000ae8f22d11fbe93939b05c1e37cf21117162d";
    src = fetchFromGitHub {
      owner = "tree-sitter-grammars";
  ...
  earthfile = buildGrammar {
    ...
    language = "earthfile";
    version = "0.0.0+rev=5baef88717ad0156fd29a8b12d0d8245bb1096a8";
    src = fetchFromGitHub {
      owner = "glehmann";
  ...
  elixir = buildGrammar {
    ...
    language = "elixir";
    version = "0.0.0+rev=4b0c7118760af58a2e7081bbc8396e136f820b37";
    src = fetchFromGitHub {
      owner = "elixir-lang";
      repo = "tree-sitter-elixir";
      rev = "4b0c7118760af58a2e7081bbc8396e136f820b37";
      hash = "sha256-FdYOWImh1mEJpAswxrnCcnGL9O4J0IWWqdXu1ndpQrg=";
    };
  ...
  elm = buildGrammar {
    passthru.name = "elm";
    language = "elm";
    version = "0.0.0+rev=e1e8fea161a1e66f3997855d316be2a43e4e956f";
    src = fetchFromGitHub {
      owner = "elm-tooling";
      repo = "tree-sitter-elm";
      rev = "e1e8fea161a1e66f3997855d316be2a43e4e956f";
      hash = "sha256-6Vnn8lGCwuQlQFmmSXPF+JKwRIR9+YI8ybmm5oZBzfA=";
    };
  ...
  enforce = buildGrammar {
    ...
    language = "enforce";
    version = "0.0.0+rev=f6daeccf744141c13b4a94c39d7de22307173735";
    src = fetchFromGitHub {
      owner = "simonvic";
      repo = "tree-sitter-enforce";
      rev = "f6daeccf744141c13b4a94c39d7de22307173735";
      hash = "sha256-3Gsqh0JlorY/+RB8Fh/fdT9qHVaw/vV+meiEe7XbhJo=";
    };
  ...
  erlang = buildGrammar {
    ...
    language = "erlang";
    version = "0.0.0+rev=6ba4c762eb3065495e3db85697ffeecdf364ce35";
    src = fetchFromGitHub {
      owner = "WhatsApp";
      repo = "tree-sitter-erlang";
      rev = "6ba4c762eb3065495e3db85697ffeecdf364ce35";
      hash = "sha256-ehRlRUXrg9EjeBLwgkJEMxuApXRdbIB8Y8xDICA8rrI=";
    };
  ...
  faust = buildGrammar {
    passthru.name = "faust";
    language = "faust";
    version = "0.0.0+rev=6074204d3511392fd0b9c4fa1cef347ded65b246";
    src = fetchFromGitHub {
      owner = "khiner";
  ...
  fennel = buildGrammar {
    ...
    language = "fennel";
    version = "0.0.0+rev=3f0f6b24d599e92460b969aabc4f4c5a914d15a0";
    src = fetchFromGitHub {
      owner = "alexmozaidze";
  ...
  fish = buildGrammar {
    passthru.name = "fish";
    language = "fish";
    version = "0.0.0+rev=b7f1d682941e0c62dfcd6bf9ef481638351bab16";
    src = fetchFromGitHub {
      owner = "ram02z";
      repo = "tree-sitter-fish";
      rev = "b7f1d682941e0c62dfcd6bf9ef481638351bab16";
      hash = "sha256-sYMpina6sLQcxH49tgHq12wCh6jDmOGczpteSTDQSsU=";
    };
  ...
  foam = buildGrammar {
    passthru.name = "foam";
    language = "foam";
    version = "0.0.0+rev=f72e493dadcca6a334c113b4cbaf864460541de4";
    src = fetchFromGitHub {
      owner = "FoamScience";
      repo = "tree-sitter-foam";
      rev = "f72e493dadcca6a334c113b4cbaf864460541de4";
      hash = "sha256-UiTvFZtJg+pC4fGW7Gl6rZpAVvY2ONJ0sUsKLeoig7o=";
    };
  ...
  forth = buildGrammar {
    passthru.name = "forth";
    language = "forth";
    version = "0.0.0+rev=7190f2173060d19a2174c96bfb5b7c6f9745512b";
    src = fetchFromGitHub {
  ...
  fortran = buildGrammar {
    ...
    language = "fortran";
    version = "0.0.0+rev=2bc0220f34ca660ec9571c54ea57ed5363338de1";
    src = fetchFromGitHub {
      owner = "stadelmanma";
      repo = "tree-sitter-fortran";
      rev = "2bc0220f34ca660ec9571c54ea57ed5363338de1";
      hash = "sha256-tkR/1Tj7jrH4XuJaWsH8joWU7XGptq2n4BJ38MCieCs=";
    };
  ...
  fsharp = buildGrammar {
    ...
    language = "fsharp";
    version = "0.0.0+rev=aefd0c8741bdf3aeb827a228aa4a996a6536697e";
    src = fetchFromGitHub {
      owner = "ionide";
  ...
  gap = buildGrammar {
    passthru.name = "gap";
    language = "gap";
    version = "0.0.0+rev=96fe2e49745ecd62b80cd19dca01fb52b83f93a1";
    src = fetchFromGitHub {
      owner = "gap-system";
  ...
  gdshader = buildGrammar {
    ...
    language = "gdshader";
    version = "0.0.0+rev=68268631c8b6dc093985f1246b099f81b30ea7d1";
    src = fetchFromGitHub {
      owner = "airblast-dev";
  ...
  git_config = buildGrammar {
    ...
    language = "git_config";
    version = "0.0.0+rev=3a61756a81a86291a0f48e3eeeaa0692b9981aa9";
    src = fetchFromGitHub {
      owner = "the-mikedavis";
      repo = "tree-sitter-git-config";
      rev = "3a61756a81a86291a0f48e3eeeaa0692b9981aa9";
      hash = "sha256-xK2AeYvvCjnMV0BqQdf3IQKnIIyllhNwQHRVCE5o0Zw=";
    };
  ...
  git_rebase = buildGrammar {
    ...
    language = "git_rebase";
    version = "0.0.0+rev=32686d6b72980b36f876ae2d07719c9c3ed154e2";
    src = fetchFromGitHub {
      owner = "the-mikedavis";
  ...
  gitcommit = buildGrammar {
    ...
    language = "gitcommit";
    version = "0.0.0+rev=55a265cf763ec15d6e2d96bb206e3f5e30d82bae";
    src = fetchFromGitHub {
      owner = "gbprod";
      repo = "tree-sitter-gitcommit";
      rev = "55a265cf763ec15d6e2d96bb206e3f5e30d82bae";
      hash = "sha256-GaxjYAfDTxhwNA3cNLCNWmmz/H1OpuD6kodSD73684E=";
    };
  ...
  gleam = buildGrammar {
    passthru.name = "gleam";
    language = "gleam";
    version = "0.0.0+rev=fa6d0d94804f1b342e175865a3dbeb316ee5115e";
    src = fetchFromGitHub {
      owner = "gleam-lang";
      repo = "tree-sitter-gleam";
      rev = "fa6d0d94804f1b342e175865a3dbeb316ee5115e";
      hash = "sha256-+mxt18HnVAzXhk1rjHe4R1YQDPm1esTS43TzSQxoxyg=";
    };
  ...
  glimmer = buildGrammar {
    ...
    language = "glimmer";
    version = "0.0.0+rev=c67a73679db2945a686ca45d3e5318d86138e72a";
    src = fetchFromGitHub {
      owner = "ember-tooling";
  ...
  glimmer_javascript = buildGrammar {
    ...
    version = "0.0.0+rev=d9cf7a2f1dad3c6b660148eaf77e955d418fdb8b";
    src = fetchFromGitHub {
      owner = "NullVoxPopuli";
  ...
  gnuplot = buildGrammar {
    ...
    language = "gnuplot";
    version = "0.0.0+rev=v4.1.0";
    src = fetchFromGitHub {
      owner = "dpezto";
      repo = "tree-sitter-gnuplot";
      tag = "v4.1.0";
      hash = "sha256-iLzFa6hpYj1ZbSWrl6cK7AskgOn+hMDbYf76U/RjAQs=";
    };
  ...
  gren = buildGrammar {
    passthru.name = "gren";
    language = "gren";
    version = "0.0.0+rev=cecd8ce9b18f1803d37682f33b6224978fd04d31";
    src = fetchFromGitHub {
      owner = "MaeBrooks";
  ...
  hack = buildGrammar {
    passthru.name = "hack";
    language = "hack";
    version = "0.0.0+rev=1a7ded90288189746c54861ac144ede97df95081";
    src = fetchFromGitHub {
      owner = "slackhq";
  ...
  haskell = buildGrammar {
    ...
    language = "haskell";
    version = "0.0.0+rev=98aedbd2d6947a168ba3ba3755d70b0cb6b78395";
    src = fetchFromGitHub {
      owner = "tree-sitter-grammars";
  ...
  hcl = buildGrammar {
    passthru.name = "hcl";
    language = "hcl";
    version = "0.0.0+rev=64ad62785d442eb4d45df3a1764962dafd5bc98b";
    src = fetchFromGitHub {
      owner = "tree-sitter-grammars";
  ...
  heex = buildGrammar {
    passthru.name = "heex";
    language = "heex";
    version = "0.0.0+rev=5842537f734d7c12685bf27d6005313e3e5a47a0";
    src = fetchFromGitHub {
      owner = "connorlay";
  ...
  htmldjango = buildGrammar {
    ...
    language = "htmldjango";
    version = "0.0.0+rev=a10318892603d9a0b925df7cc7771a840304b997";
    src = fetchFromGitHub {
  ...
  hyprlang = buildGrammar {
    ...
    language = "hyprlang";
    version = "0.0.0+rev=cecd6b748107d9da1f7b4ca03ef95f1f71d93b8f";
    src = fetchFromGitHub {
      owner = "tree-sitter-grammars";
  ...
  idl = buildGrammar {
    passthru.name = "idl";
    language = "idl";
    version = "0.0.0+rev=b5ecf511e542e43313ba4602bdb206a08cb06232";
    src = fetchFromGitHub {
      owner = "cathaysia";
      repo = "tree-sitter-idl";
      rev = "b5ecf511e542e43313ba4602bdb206a08cb06232";
      hash = "sha256-xicg2PNvB/xmkmgCWAaZ7bVzYLO61MyRkwBdEKQCqc4=";
    };
  ...
  idris = buildGrammar {
    passthru.name = "idris";
    language = "idris";
    version = "0.0.0+rev=9fe334fb603fdce0e84349ed78f41ae3d2f7036b";
    src = fetchFromGitHub {
      owner = "kayhide";
      repo = "tree-sitter-idris";
      rev = "9fe334fb603fdce0e84349ed78f41ae3d2f7036b";
      hash = "sha256-Y3UN9sldWw5MLvdi8bGTzid2p5h27pMICEb6tvZbC4w=";
    };
  ...
  ispc = buildGrammar {
    passthru.name = "ispc";
    language = "ispc";
    version = "0.0.0+rev=ba1bb38ac8ddfa6aa7571cbfe9b4d029f7f77447";
    src = fetchFromGitHub {
      owner = "tree-sitter-grammars";
  ...
  janet_simple = buildGrammar {
    ...
    version = "0.0.0+rev=3c1bdcfff374138da03a1db25c75efce623910fe";
    src = fetchFromGitHub {
      owner = "sogaiu";
  ...
  javadoc = buildGrammar {
    ...
    language = "javadoc";
    version = "0.0.0+rev=4e9e1db7a116244aaa248f0cf58ca058694a0de4";
    src = fetchFromGitHub {
      owner = "rmuir";
      repo = "tree-sitter-javadoc";
      rev = "4e9e1db7a116244aaa248f0cf58ca058694a0de4";
      hash = "sha256-PPq8SNVowtYYIsMGU1F6QvIPb7Ry56I7AHMeBU0sq+Q=";
    };
  ...
  jinja = buildGrammar {
    passthru.name = "jinja";
    language = "jinja";
    version = "0.0.0+rev=c213d3745ccdcaaa858869181c7b1bf9557a025f";
    src = fetchFromGitHub {
      owner = "cathaysia";
  ...
  json = buildGrammar {
    passthru.name = "json";
    language = "json";
    version = "0.0.0+rev=254c42a6476413b776221e03982ac8ae159eeb72";
    src = fetchFromGitHub {
      owner = "tree-sitter";
      repo = "tree-sitter-json";
      rev = "254c42a6476413b776221e03982ac8ae159eeb72";
      hash = "sha256-gK4suNfS1Olq3pONPSH+Uyn820ru5TQqgl5q3wN/ADU=";
    };
  ...
  json5 = buildGrammar {
    passthru.name = "json5";
    language = "json5";
    version = "0.0.0+rev=248b8564567087d7866be76569b182f6dd7e14e9";
    src = fetchFromGitHub {
      owner = "Joakker";
  ...
  just = buildGrammar {
    passthru.name = "just";
    language = "just";
    version = "0.0.0+rev=5685543a6e64f66335e25518c9ae8ffa1dae3d01";
    src = fetchFromGitHub {
      owner = "IndianBoy42";
  ...
  kcl = buildGrammar {
    passthru.name = "kcl";
    language = "kcl";
    version = "0.0.0+rev=6a5cc921928660cd6756cd6e0d636d9e24ea348e";
    src = fetchFromGitHub {
      owner = "kcl-lang";
      repo = "tree-sitter-kcl";
      rev = "6a5cc921928660cd6756cd6e0d636d9e24ea348e";
      hash = "sha256-LWsix0V2gdKz5Ka59lueQzwGAd9qtQgaMgS//bmoeN4=";
    };
  ...
  kitty = buildGrammar {
    passthru.name = "kitty";
    language = "kitty";
    version = "0.0.0+rev=0e3eca6e786356bd37b1633f5e8b5a1c864333c1";
    src = fetchFromGitHub {
      owner = "OXY2DEV";
      repo = "tree-sitter-kitty";
      rev = "0e3eca6e786356bd37b1633f5e8b5a1c864333c1";
      hash = "sha256-P0w20or2xoXznUpa1jzyfPs9//84YhX+EbxFkAUffJ4=";
    };
  ...
  kos = buildGrammar {
    passthru.name = "kos";
    language = "kos";
    version = "0.0.0+rev=a7338629da17c5246dc2129cd2a493a6ee59e922";
    src = fetchFromGitHub {
      owner = "kos-lang";
  ...
  kotlin = buildGrammar {
    ...
    language = "kotlin";
    version = "0.0.0+rev=1852ea17b7f60fb3f9d84e0b1555d56b46b39fb1";
    src = fetchFromGitHub {
      owner = "fwcd";
      repo = "tree-sitter-kotlin";
      rev = "1852ea17b7f60fb3f9d84e0b1555d56b46b39fb1";
      hash = "sha256-7pFQyuRy2tJTL8g3zi6Q1W4AzaNpucu09lae4lmBEyE=";
    };
  ...
  koto = buildGrammar {
    passthru.name = "koto";
    language = "koto";
    version = "0.0.0+rev=e8d41cbaca867aa1b0213e1fc1caeaf593da7bf7";
    src = fetchFromGitHub {
      owner = "koto-lang";
  ...
  lalrpop = buildGrammar {
    ...
    language = "lalrpop";
    version = "0.0.0+rev=27b0f7bb55b4cabd8f01a933d9ee6a49dbfc2192";
    src = fetchFromGitHub {
      owner = "traxys";
  ...
  latex = buildGrammar {
    passthru.name = "latex";
    language = "latex";
    version = "0.0.0+rev=fa8df448fc2c0192a8c2f8cfc97de53cb2b4ecb9";
    src = fetchFromGitHub {
      owner = "latex-lsp";
      repo = "tree-sitter-latex";
      rev = "fa8df448fc2c0192a8c2f8cfc97de53cb2b4ecb9";
      hash = "sha256-mJffnFVB6qNT1Me38/dmzit+Wp6+5MfMJB4QiJHJmCE=";
    };
  ...
  ledger = buildGrammar {
    ...
    language = "ledger";
    version = "0.0.0+rev=22a1ab8195c1f6e808679f803007756fe7638c6f";
    src = fetchFromGitHub {
      owner = "cbarrete";
  ...
  liquid = buildGrammar {
    ...
    language = "liquid";
    version = "0.0.0+rev=e45dbac8c5fa95b1f0e00e7e0c04bc8855823391";
    src = fetchFromGitHub {
      owner = "hankthetank27";
  ...
  liquidsoap = buildGrammar {
    ...
    language = "liquidsoap";
    version = "0.0.0+rev=301f66950622949f630fef9fa758ba69f66cf97a";
    src = fetchFromGitHub {
      owner = "savonet";
  ...
  lua = buildGrammar {
    passthru.name = "lua";
    language = "lua";
    version = "0.0.0+rev=10fe0054734eec83049514ea2e718b2a56acd0c9";
    src = fetchFromGitHub {
      owner = "tree-sitter-grammars";
  ...
  luadoc = buildGrammar {
    ...
    language = "luadoc";
    version = "0.0.0+rev=4d04632a3a398b78af52e83be074883e722f40be";
    src = fetchFromGitHub {
      owner = "tree-sitter-grammars";
      repo = "tree-sitter-luadoc";
      rev = "4d04632a3a398b78af52e83be074883e722f40be";
      hash = "sha256-PgRCFFOqkNH63VZXr/0Kri3rXm2zmsq8nOEUlrlE1b4=";
    };
  ...
  m68k = buildGrammar {
    passthru.name = "m68k";
    language = "m68k";
    version = "0.0.0+rev=ab9f2ad96db56619d05a6474a52e3dbdd705a637";
    src = fetchFromGitHub {
      owner = "grahambates";
  ...
  make = buildGrammar {
    passthru.name = "make";
    language = "make";
    version = "0.0.0+rev=70613f3d812cbabbd7f38d104d60a409c4008b43";
    src = fetchFromGitHub {
      owner = "tree-sitter-grammars";
  ...
  markdown = buildGrammar {
    ...
    language = "markdown";
    version = "0.0.0+rev=a0a00f817d02412bd92c54d316f164d827b57b5c";
    src = fetchFromGitHub {
      owner = "tree-sitter-grammars";
      repo = "tree-sitter-markdown";
      rev = "a0a00f817d02412bd92c54d316f164d827b57b5c";
      hash = "sha256-IusQiUs34Ge0Ui7kyLiNA/mHaYMmVJLaMdC0ILmT8Hg=";
    };
  ...
  matlab = buildGrammar {
    ...
    language = "matlab";
    version = "0.0.0+rev=f03d0347acd8bb05d4edd8c845ac1718729e1fad";
    src = fetchFromGitHub {
      owner = "acristoffers";
  ...
  meson = buildGrammar {
    passthru.name = "meson";
    language = "meson";
    version = "0.0.0+rev=aa8d472034956f94f51f2ef2cbfec4cc07efbfde";
    src = fetchFromGitHub {
      owner = "tree-sitter-grammars";
  ...
  mlir = buildGrammar {
    passthru.name = "mlir";
    language = "mlir";
    version = "0.0.0+rev=eb0541bba21c4ebb3661f02332d1f087d72dbc7c";
    src = fetchFromGitHub {
      owner = "artagnon";
  ...
  nginx = buildGrammar {
    passthru.name = "nginx";
    language = "nginx";
    version = "0.0.0+rev=7cdf006ed1addef698fc680ae31721950f85e5e9";
    src = fetchFromGitHub {
      owner = "opa-oz";
      repo = "tree-sitter-nginx";
      rev = "7cdf006ed1addef698fc680ae31721950f85e5e9";
      hash = "sha256-Odo9YYQmM0eoi4nvfHwzBD0XxAl5fAQhcuOAjS9amm8=";
    };
  ...
  nickel = buildGrammar {
    ...
    language = "nickel";
    version = "0.0.0+rev=fd65591d3c7812b0e3e733506f3f08a354a38ea6";
    src = fetchFromGitHub {
      owner = "nickel-lang";
      repo = "tree-sitter-nickel";
      rev = "fd65591d3c7812b0e3e733506f3f08a354a38ea6";
      hash = "sha256-882e4ot/nEaRZ+YvVxn8IIfVlhmD44AnWgEhp5xfN6U=";
    };
  ...
  nim = buildGrammar {
    passthru.name = "nim";
    language = "nim";
    version = "0.0.0+rev=ac72ba30d16edf0be021588a9301ede4accd6cf4";
    src = fetchFromGitHub {
      owner = "alaviss";
  ...
  nix = buildGrammar {
    passthru.name = "nix";
    language = "nix";
    version = "0.0.0+rev=17f290c8b5104d9aba8a1ba7383a2ca83c3d14c4";
    src = fetchFromGitHub {
      owner = "nix-community";
  ...
  nu = buildGrammar {
    passthru.name = "nu";
    language = "nu";
    version = "0.0.0+rev=4f577aaa735154f934594b598a69ed7b1b707cf6";
    src = fetchFromGitHub {
      owner = "nushell";
      repo = "tree-sitter-nu";
      rev = "4f577aaa735154f934594b598a69ed7b1b707cf6";
      hash = "sha256-kORiz85hud0dCGW+k/qEBew+4493a6Ij8qrT5+mFoGE=";
    };
  ...
  ocaml = buildGrammar {
    passthru.name = "ocaml";
    language = "ocaml";
    version = "0.0.0+rev=e3c9cf368f68bffd2f81188229aefa7b434eda65";
    src = fetchFromGitHub {
      owner = "tree-sitter";
  ...
  ocamllex = buildGrammar {
    ...
    language = "ocamllex";
    version = "0.0.0+rev=33722b8be73079946a7c6dd9598e3f57956ed36d";
    src = fetchFromGitHub {
      owner = "atom-ocaml";
  ...
  pascal = buildGrammar {
    ...
    language = "pascal";
    version = "0.0.0+rev=042119eca2e18a60e56317fb06ee3ba5c32cb447";
    src = fetchFromGitHub {
      owner = "Isopod";
  ...
  perl = buildGrammar {
    passthru.name = "perl";
    language = "perl";
    version = "0.0.0+rev=f678e356280566100e7eed21716d6f59abdf96b7";
    src = fetchFromGitHub {
      owner = "tree-sitter-perl";
      repo = "tree-sitter-perl";
      rev = "f678e356280566100e7eed21716d6f59abdf96b7";
      hash = "sha256-teMMSUPOlxzA+0edCIbxyvf/zoO3HBgDcKsoBVaOL40=";
    };
  ...
  php = buildGrammar {
    passthru.name = "php";
    language = "php";
    version = "0.0.0+rev=3fda2fb9577166c6399834917f9844f30370beea";
    src = fetchFromGitHub {
      owner = "tree-sitter";
  ...
  phpdoc = buildGrammar {
    ...
    language = "phpdoc";
    version = "0.0.0+rev=12d50307e6c02e5f4f876fa6cf2edea1f7808c0d";
    src = fetchFromGitHub {
  ...
  pkl = buildGrammar {
    passthru.name = "pkl";
    language = "pkl";
    version = "0.0.0+rev=9eaf196bb1cb9ce862036ed28b188ab6664a2492";
    src = fetchFromGitHub {
      owner = "apple";
  ...
  pod = buildGrammar {
    passthru.name = "pod";
    language = "pod";
    version = "0.0.0+rev=ffbd7f3b7b68edaaa0532898953c627355cb1a1a";
    src = fetchFromGitHub {
      owner = "tree-sitter-perl";
  ...
  powershell = buildGrammar {
    ...
    language = "powershell";
    version = "0.0.0+rev=e7bd348c49fdfd5c853a146a670965ba516a6239";
    src = fetchFromGitHub {
      owner = "airbus-cert";
  ...
  proto = buildGrammar {
    passthru.name = "proto";
    language = "proto";
    version = "0.0.0+rev=6c878d18628ebbff3474479d2fdd6d8ba1954c3e";
    src = fetchFromGitHub {
      owner = "coder3101";
  ...
  qmldir = buildGrammar {
    ...
    language = "qmldir";
    version = "0.0.0+rev=c57e00865a1a6f1cca83340d6dad91f13df55479";
    src = fetchFromGitHub {
      owner = "tree-sitter-grammars";
  ...
  qmljs = buildGrammar {
    passthru.name = "qmljs";
    language = "qmljs";
    version = "0.0.0+rev=de96ed62abded51fcdfcbeaaa120e0dd0d20c697";
    src = fetchFromGitHub {
      owner = "yuja";
  ...
  query = buildGrammar {
    passthru.name = "query";
    language = "query";
    version = "0.0.0+rev=8e9e223812ff30854fbc912adbec696ba5f0e023";
    src = fetchFromGitHub {
      owner = "tree-sitter-grammars";
  ...
  r = buildGrammar {
    passthru.name = "r";
    language = "r";
    version = "0.0.0+rev=58a22794466c0fc15b0d3b40531db751593721e8";
    src = fetchFromGitHub {
      owner = "r-lib";
      repo = "tree-sitter-r";
  ...
  racket = buildGrammar {
    ...
    language = "racket";
    version = "0.0.0+rev=b3cbbde75ce2de3079e33c7fe90bd41b1d45be48";
    src = fetchFromGitHub {
      owner = "6cdh";
      repo = "tree-sitter-racket";
      rev = "b3cbbde75ce2de3079e33c7fe90bd41b1d45be48";
      hash = "sha256-QSlMxijWwYOtZPjZF1KpqLXbmu15e2g7JXp6ABaP6AY=";
    };
  ...
  razor = buildGrammar {
    passthru.name = "razor";
    language = "razor";
    version = "0.0.0+rev=d4664e409caaea12f73c9525484e3cf88b1cf718";
    src = fetchFromGitHub {
      owner = "tris203";
      repo = "tree-sitter-razor";
      rev = "d4664e409caaea12f73c9525484e3cf88b1cf718";
      hash = "sha256-gmW7eKUKe7B06qLvkEyterVI41vzC07UXvfd0s+S0P0=";
    };
  ...
  readline = buildGrammar {
    ...
    language = "readline";
    version = "0.0.0+rev=6b744c527aebd12e46a5ecb3aebdb8d621a8e83e";
    src = fetchFromGitHub {
      owner = "tree-sitter-grammars";
  ...
  rego = buildGrammar {
    passthru.name = "rego";
    language = "rego";
    version = "0.0.0+rev=da2a1f63cd877efb05d56de61fe516e90012b9a7";
    src = fetchFromGitHub {
      owner = "FallenAngel97";
      repo = "tree-sitter-rego";
      rev = "da2a1f63cd877efb05d56de61fe516e90012b9a7";
      hash = "sha256-FIZsxmP66BNAzYRba5ExOeEtQBU5fm/uKH+P4TvxL/s=";
    };
  ...
  requirements = buildGrammar {
    ...
    version = "0.0.0+rev=2c3bb291f497258ba417d052faa14a2dfee6d401";
    src = fetchFromGitHub {
      owner = "tree-sitter-grammars";
  ...
  rescript = buildGrammar {
    ...
    language = "rescript";
    version = "0.0.0+rev=19ed8a8e6bcc844b71c37e9edaffc60c77f74d7c";
    src = fetchFromGitHub {
      owner = "rescript-lang";
  ...
  rifleconf = buildGrammar {
    ...
    language = "rifleconf";
    version = "0.0.0+rev=6389ef0fc0d48f0397ec233109c074a0cb685e36";
    src = fetchFromGitHub {
      owner = "purarue";
  ...
  robots_txt = buildGrammar {
    passthru.name = "robots_txt";
    language = "robots_txt";
    version = "0.0.0+rev=0c066107e3548de79316a6a4ec771e2f7cf7c468";
    src = fetchFromGitHub {
      owner = "opa-oz";
  ...
  rst = buildGrammar {
    passthru.name = "rst";
    language = "rst";
    version = "0.0.0+rev=a60f1070b824cb8bb8409b4b6d7da0d07997c30e";
    src = fetchFromGitHub {
      owner = "stsewd";
  ...
  ruby = buildGrammar {
    passthru.name = "ruby";
    language = "ruby";
    version = "0.0.0+rev=ad907a69da0c8a4f7a943a7fe012712208da6dee";
    src = fetchFromGitHub {
      owner = "tree-sitter";
  ...
  rust = buildGrammar {
    passthru.name = "rust";
    language = "rust";
    version = "0.0.0+rev=77a3747266f4d621d0757825e6b11edcbf991ca5";
    src = fetchFromGitHub {
      owner = "tree-sitter";
  ...
  scala = buildGrammar {
    passthru.name = "scala";
    language = "scala";
    version = "0.0.0+rev=db390f312a54b04b13790e1767bfac32665c17ac";
    src = fetchFromGitHub {
      owner = "tree-sitter";
      repo = "tree-sitter-scala";
      rev = "db390f312a54b04b13790e1767bfac32665c17ac";
      hash = "sha256-3RVv9bI0KUBWehf2+x9ZRHFrfUabyq2zK/G3SjNdAes=";
    };
  ...
  scheme = buildGrammar {
    ...
    language = "scheme";
    version = "0.0.0+rev=c6cb7c7d7a04b3f5d999c28e2e9c0c31b2d50ece";
    src = fetchFromGitHub {
      owner = "6cdh";
  ...
  slim = buildGrammar {
    passthru.name = "slim";
    language = "slim";
    version = "0.0.0+rev=d4ff7e388eb271c04662f2176c08548c9c51078f";
    src = fetchFromGitHub {
      owner = "theoo";
  ...
  slint = buildGrammar {
    passthru.name = "slint";
    language = "slint";
    version = "0.0.0+rev=68b25244cec6eb9d7f8f790ef781c29c822d8f84";
    src = fetchFromGitHub {
      owner = "slint-ui";
  ...
  sourcepawn = buildGrammar {
    ...
    language = "sourcepawn";
    version = "0.0.0+rev=2ef2d389c29b952f8b23909783f7d3c7972046f5";
    src = fetchFromGitHub {
      owner = "nilshelmig";
      repo = "tree-sitter-sourcepawn";
      rev = "2ef2d389c29b952f8b23909783f7d3c7972046f5";
      hash = "sha256-IJy2Fqkbupai/BufZOW2BFauxpLcroud1/FaOxZ7LHc=";
    };
  ...
  sql = buildGrammar {
    passthru.name = "sql";
    language = "sql";
    version = "0.0.0+rev=39fdb006403747241244326e8af3b3e96b85381c";
    src = fetchFromGitHub {
      owner = "derekstride";
      repo = "tree-sitter-sql";
      rev = "39fdb006403747241244326e8af3b3e96b85381c";
      hash = "sha256-O8STRLlJLvIBzNvLKaCJyoqVVWCO0Vgw/nhDmE0Z+Mo=";
    };
  ...
  ssh_config = buildGrammar {
    ...
    language = "ssh_config";
    version = "0.0.0+rev=0c35b243392268f48fd096607da192d76c843398";
    src = fetchFromGitHub {
      owner = "tree-sitter-grammars";
      repo = "tree-sitter-ssh-config";
      rev = "0c35b243392268f48fd096607da192d76c843398";
      hash = "sha256-hpha4bEO2/gSool/SLG2hFMKSadwcwm23TIOEiCeyFE=";
    };
  ...
  strace = buildGrammar {
    ...
    language = "strace";
    version = "0.0.0+rev=ac874ddfcc08d689fee1f4533789e06d88388f29";
    src = fetchFromGitHub {
      owner = "sigmaSd";
  ...
  supercollider = buildGrammar {
    ...
    version = "0.0.0+rev=2b03ff49dd19b046add072d0861c4d1ca8a384c8";
    src = fetchFromGitHub {
  ...
  superhtml = buildGrammar {
    ...
    language = "superhtml";
    version = "0.0.0+rev=23ef2f44ca0df2d2e05a0be3874370553c5b591d";
    src = fetchFromGitHub {
      owner = "kristoff-it";
      repo = "superhtml";
  ...
  swift = buildGrammar {
    passthru.name = "swift";
    language = "swift";
    version = "0.0.0+rev=00bbb0a2550f8bc0023a2a4992922d51ae045626";
    src = fetchFromGitHub {
      owner = "alex-pinkus";
  ...
  t32 = buildGrammar {
    passthru.name = "t32";
    language = "t32";
    version = "0.0.0+rev=11947ac01ba681fb6f62667cb1447354833f4a5b";
    src = fetchFromGitHub {
      owner = "xasc";
      repo = "tree-sitter-t32";
      rev = "11947ac01ba681fb6f62667cb1447354833f4a5b";
  ...
  tact = buildGrammar {
    passthru.name = "tact";
    language = "tact";
    version = "0.0.0+rev=1c689f0a8bbe5910db628a62bfc26d37f54bf9be";
    src = fetchFromGitHub {
      owner = "tact-lang";
  ...
  tcl = buildGrammar {
    passthru.name = "tcl";
    language = "tcl";
    version = "0.0.0+rev=850a72ab6436e06645b33b11cfa60cbdb04b1f01";
    src = fetchFromGitHub {
      owner = "tree-sitter-grammars";
  ...
  templ = buildGrammar {
    passthru.name = "templ";
    language = "templ";
    version = "0.0.0+rev=94d40865c15ebbaff9ed11dde5d6490b0f5de092";
    src = fetchFromGitHub {
      owner = "vrischmann";
      repo = "tree-sitter-templ";
      rev = "94d40865c15ebbaff9ed11dde5d6490b0f5de092";
      hash = "sha256-WEDz1Z3iwh3X8DqwQpzf/dl0uOLlOmDsm5k7YhbBDow=";
    };
  ...
  tera = buildGrammar {
    passthru.name = "tera";
    language = "tera";
    version = "0.0.0+rev=3a38c368e806268daac9923a27e72bcafbbc16bb";
    src = fetchFromGitHub {
      owner = "uncenter";
  ...
  twig = buildGrammar {
    passthru.name = "twig";
    language = "twig";
    version = "0.0.0+rev=2208d2a3c3ee7ef378e97df2e51c18feb7ee9dfc";
    src = fetchFromGitHub {
      owner = "gbprod";
      repo = "tree-sitter-twig";
      rev = "2208d2a3c3ee7ef378e97df2e51c18feb7ee9dfc";
      hash = "sha256-hit7LWlrZJxhmyfCeHruGc4tocbJ6SDjcjAZoe3nZ+Y=";
    };
  ...
  typespec = buildGrammar {
    ...
    language = "typespec";
    version = "0.0.0+rev=395bef1e1eb4dd18365401642beb534e8a244056";
    src = fetchFromGitHub {
      owner = "happenslol";
  ...
  typoscript = buildGrammar {
    ...
    language = "typoscript";
    version = "0.0.0+rev=b5d0162b328ec52cf300054a8a23d47f84f55cb4";
    src = fetchFromGitHub {
      owner = "Teddytrombone";
  ...
  unison = buildGrammar {
    ...
    language = "unison";
    version = "0.0.0+rev=10365cc70ab2b2de85ea7ab35cf6b7636c36ce8b";
    src = fetchFromGitHub {
      owner = "kylegoetz";
  ...
  usd = buildGrammar {
    passthru.name = "usd";
    language = "usd";
    version = "0.0.0+rev=7bbe1e8dc991bd488e6a96f7931316f55a401589";
    src = fetchFromGitHub {
      owner = "ColinKennedy";
      repo = "tree-sitter-usd";
      rev = "7bbe1e8dc991bd488e6a96f7931316f55a401589";
  ...
  v = buildGrammar {
    passthru.name = "v";
    language = "v";
    version = "0.0.0+rev=925d4570d1668746762a2cdf0ecb9a25be704a67";
    src = fetchFromGitHub {
      owner = "vlang";
      repo = "v-analyzer";
  ...
  vhdl = buildGrammar {
    passthru.name = "vhdl";
    language = "vhdl";
    version = "0.0.0+rev=9be8e45c3ae7e7a4373a943a5c81ff92ce3656f8";
    src = fetchFromGitHub {
      owner = "jpt13653903";
  ...
  vim = buildGrammar {
    passthru.name = "vim";
    language = "vim";
    version = "0.0.0+rev=039c8d0aa1deae00ddeb0374dd70bcc0ec56938d";
    src = fetchFromGitHub {
      owner = "tree-sitter-grammars";
  ...
  vimdoc = buildGrammar {
    ...
    language = "vimdoc";
    version = "0.0.0+rev=23daa416c1ff5d15f59a1aa648f031d6e3ee15c5";
    src = fetchFromGitHub {
      owner = "neovim";
  ...
  vue = buildGrammar {
    passthru.name = "vue";
    language = "vue";
    version = "0.0.0+rev=ce8011a414fdf8091f4e4071752efc376f4afb08";
    src = fetchFromGitHub {
      owner = "tree-sitter-grammars";
  ...
  wxml = buildGrammar {
    passthru.name = "wxml";
    language = "wxml";
    version = "0.0.0+rev=1cc1761c8c11cacab5516dbe64e20ee689aa4428";
    src = fetchFromGitHub {
      owner = "BlockLune";
      repo = "tree-sitter-wxml";
      rev = "1cc1761c8c11cacab5516dbe64e20ee689aa4428";
      hash = "sha256-RoeEY/Xc8bP+0/l9cQgCejyB5nPLdK6CYlOoVEjIiik=";
    };
  ...
  yaml = buildGrammar {
    passthru.name = "yaml";
    language = "yaml";
    version = "0.0.0+rev=a1c4812a73ec5e089de8e441fdea3a921e8d5079";
    src = fetchFromGitHub {
      owner = "tree-sitter-grammars";
  ...
  yuck = buildGrammar {
    passthru.name = "yuck";
    language = "yuck";
    version = "0.0.0+rev=6c60112b3b3e739fb1ca4a8ea4bea2b6ffe11318";
    src = fetchFromGitHub {
      owner = "tree-sitter-grammars";
  ...
  zsh = buildGrammar {
    passthru.name = "zsh";
    language = "zsh";
    version = "0.0.0+rev=7a593401efb5418ffdedbe3c0e4c61c6d240166d";
    src = fetchFromGitHub {
      owner = "georgeharker";
