...
}:
{
  ...
  desktop = buildGrammar {
    ...
    language = "desktop";
    version = "0.0.0+rev=137292ae28e05011dbc7c5c383e2b25db1cf77c9";
    src = fetchFromGitHub {
      owner = "ValdezFOmar";
  ...
  editorconfig = buildGrammar {
    ...
    version = "0.0.0+rev=851f2c2483239ce62f919bf3408ccd20dc0b5c01";
    src = fetchFromGitHub {
      owner = "ValdezFOmar";
  ...
  lua = buildGrammar {
    passthru.name = "lua";
    language = "lua";
    version = "0.0.0+rev=e40f5b6e6df9c2d1d6d664ff5d346a75d71ee6b2";
    src = fetchFromGitHub {
      owner = "tree-sitter-grammars";
  ...
  mlir = buildGrammar {
    passthru.name = "mlir";
    language = "mlir";
    version = "0.0.0+rev=4ab28ecdacef343af56c09b7981580503e49fadb";
    src = fetchFromGitHub {
      owner = "artagnon";
  ...
  swift = buildGrammar {
    passthru.name = "swift";
    language = "swift";
    version = "0.0.0+rev=c7287392d610ca9d7c80f9edd2c6ef8f518b377b";
    src = fetchFromGitHub {
      owner = "alex-pinkus";
  ...
  vim = buildGrammar {
    passthru.name = "vim";
    language = "vim";
    version = "0.0.0+rev=1cd0a0892b389bd314a9bd09545160e5ee3c9137";
    src = fetchFromGitHub {
      owner = "tree-sitter-grammars";
  ...
  xresources = buildGrammar {
    ...
    language = "xresources";
    version = "0.0.0+rev=a81f1ea4478d03c223ef7eace535a36220bddd8c";
    src = fetchFromGitHub {
      owner = "ValdezFOmar";
