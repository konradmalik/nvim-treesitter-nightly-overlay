...
}:
{
  ...
  bpftrace = buildGrammar {
    ...
    language = "bpftrace";
    version = "0.0.0+rev=dee4269b564fdf7071ee454e873767fd334f79ae";
    src = fetchFromGitHub {
      owner = "sgruszka";
  ...
  desktop = buildGrammar {
    ...
    language = "desktop";
    version = "0.0.0+rev=c0279c1fb1e2e1f06f374437815d4abda02e30b2";
    src = fetchFromGitHub {
      owner = "ValdezFOmar";
  ...
  editorconfig = buildGrammar {
    ...
    version = "0.0.0+rev=f8e8a4cefe4de5d7e87bd129f3a69bdcdf73eebe";
    src = fetchFromGitHub {
      owner = "ValdezFOmar";
  ...
  javadoc = buildGrammar {
    ...
    language = "javadoc";
    version = "0.0.0+rev=373fbd84f35aff70031426ed6edf3cdf52b93532";
    src = fetchFromGitHub {
      owner = "rmuir";
  ...
  matlab = buildGrammar {
    ...
    language = "matlab";
    version = "0.0.0+rev=1bccabdbd420a9c3c3f96f36d7f9e65b3d9c88ef";
    src = fetchFromGitHub {
      owner = "acristoffers";
  ...
  meson = buildGrammar {
    passthru.name = "meson";
    language = "meson";
    version = "0.0.0+rev=d4fa3c7260d1537ac5183740b9338373a673d5c0";
    src = fetchFromGitHub {
      owner = "tree-sitter-grammars";
  ...
  mlir = buildGrammar {
    passthru.name = "mlir";
    language = "mlir";
    version = "0.0.0+rev=9edc9201736c5a471314b4e28c20d0f0b4642b6f";
    src = fetchFromGitHub {
      owner = "artagnon";
  ...
  swift = buildGrammar {
    passthru.name = "swift";
    language = "swift";
    version = "0.0.0+rev=82a239e4c164b0567fb99b80b53f99ba661f2168";
    src = fetchFromGitHub {
      owner = "alex-pinkus";
  ...
  vhdl = buildGrammar {
    passthru.name = "vhdl";
    language = "vhdl";
    version = "0.0.0+rev=7ae08deb5d1641aa57111342218ca1e1b3a5d539";
    src = fetchFromGitHub {
      owner = "jpt13653903";
  ...
  xresources = buildGrammar {
    ...
    language = "xresources";
    version = "0.0.0+rev=f60fb1e661d85f35fb8e7b988a41d2a74f65bfd4";
    src = fetchFromGitHub {
      owner = "ValdezFOmar";
