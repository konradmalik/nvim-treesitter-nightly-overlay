...
}:
{
  ...
  beancount = buildGrammar {
    ...
    language = "beancount";
    version = "0.0.0+rev=d7a03a7506fbbbc4b16a9a2054ff7c2b337744b8";
    src = fetchFromGitHub {
      owner = "polarmutex";
  ...
  gotmpl = buildGrammar {
    ...
    language = "gotmpl";
    version = "0.0.0+rev=04270cd3512e2c7de0c5f2823725d7b0c4c01fda";
    src = fetchFromGitHub {
      owner = "ngalaiko";
  ...
  heex = buildGrammar {
    passthru.name = "heex";
    language = "heex";
    version = "0.0.0+rev=3968d6e20b3c4cc234f339eddd6b7d118516e281";
    src = fetchFromGitHub {
      owner = "connorlay";
  ...
  idl = buildGrammar {
    passthru.name = "idl";
    language = "idl";
    version = "0.0.0+rev=57c4ba057415ebe8e184fb11716c985dc3545e5e";
    src = fetchFromGitHub {
      owner = "cathaysia";
  ...
  javadoc = buildGrammar {
    ...
    language = "javadoc";
    version = "0.0.0+rev=42c9bc340c90ec15ed96eb4314269e8249376be9";
    src = fetchFromGitHub {
      owner = "rmuir";
  ...
  jinja = buildGrammar {
    passthru.name = "jinja";
    language = "jinja";
    version = "0.0.0+rev=7bd0422c6a57aaabfee8603502d7708d0a536f5f";
    src = fetchFromGitHub {
      owner = "cathaysia";
  ...
  just = buildGrammar {
    passthru.name = "just";
    language = "just";
    version = "0.0.0+rev=d9da862c156020c1a83d3c6ccdda32be6d8a5d4a";
    src = fetchFromGitHub {
      owner = "IndianBoy42";
  ...
  kotlin = buildGrammar {
    ...
    language = "kotlin";
    version = "0.0.0+rev=802fd920c153b02b9d266369a3ef061622f2bbf0";
    src = fetchFromGitHub {
      owner = "fwcd";
  ...
  liquid = buildGrammar {
    ...
    language = "liquid";
    version = "0.0.0+rev=fa11c7ba45038b61e03a8a00ad667fb5f3d72088";
    src = fetchFromGitHub {
      owner = "hankthetank27";
  ...
  mlir = buildGrammar {
    passthru.name = "mlir";
    language = "mlir";
    version = "0.0.0+rev=90d41fd327a8a6ded2fb366909ea86d8e31392ea";
    src = fetchFromGitHub {
      owner = "artagnon";
  ...
  pkl = buildGrammar {
    passthru.name = "pkl";
    language = "pkl";
    version = "0.0.0+rev=7c8a0d15d83c1a436e91277d5023340f1ae5726b";
    src = fetchFromGitHub {
      owner = "apple";
  ...
  rust = buildGrammar {
    passthru.name = "rust";
    language = "rust";
    version = "0.0.0+rev=8a1ccae7aaccdc11b04dbd803453e3e9cfd9159b";
    src = fetchFromGitHub {
      owner = "tree-sitter";
  ...
  supercollider = buildGrammar {
    ...
    version = "0.0.0+rev=e2d1480de0a62cd53f81645cb39bc1f3fa2dce5a";
    src = fetchFromGitHub {
  ...
  typoscript = buildGrammar {
    ...
    language = "typoscript";
    version = "0.0.0+rev=1811c767f3f72be669891b524a07c58b1eb0db87";
    src = fetchFromGitHub {
      owner = "Teddytrombone";
