...
}:
{
  ...
  beancount = buildGrammar {
    ...
    language = "beancount";
    version = "0.0.0+rev=653cce316fbff8d212a2488ae13df648efb542a4";
    src = fetchFromGitHub {
      owner = "polarmutex";
  ...
  c3 = buildGrammar {
    passthru.name = "c3";
    language = "c3";
    version = "0.0.0+rev=805f776dcfbfef5c9baf4270ec942b3e8dc7ff16";
    src = fetchFromGitHub {
      owner = "c3lang";
      repo = "tree-sitter-c3";
  ...
  lua = buildGrammar {
    passthru.name = "lua";
    language = "lua";
    version = "0.0.0+rev=e284fcec45ead0d477e326fccd2cd4a68a89dae4";
    src = fetchFromGitHub {
      owner = "tree-sitter-grammars";
  ...
  mlir = buildGrammar {
    passthru.name = "mlir";
    language = "mlir";
    version = "0.0.0+rev=c7eec06be8a9ddae688e1b03fca2eed79e9801c4";
    src = fetchFromGitHub {
      owner = "artagnon";
  ...
  sql = buildGrammar {
    passthru.name = "sql";
    language = "sql";
    version = "0.0.0+rev=2d5dcd16f9ee49cb5a6d99eabb00fd4ea298587f";
    src = fetchFromGitHub {
      owner = "derekstride";
